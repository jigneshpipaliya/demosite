    ...
    return(
        ...
        <div className="slider">
            ...
            <div className="relative">
                <h5 className=" text-white ml-28 font-semibold">Prepare For New Future</h5>
                <h1 className=" text-white ml-24 font-bold text-7xl my-4" >Our work is </h1>
                <h1 className=" text-white ml-24 font-bold text-7xl my-4"> presentation of our</h1>
                <h1 className=" text-white ml-24 font-bold text-7xl my-4">capabilities.</h1>
                 <button className=" bg-red-500 hover:bg-red-700 text-red-50 ml-28 mt-8 px-4 text-sm font-semibold py-3 rounded-full ">GET STARTED  <ChevronRightIcon className=''/></button>
            </div>
        </div>
            ...
            <div>
              ...
              <h1 className=' text-5xl font-semibold mt-4 leading-tight '>We work with business & provide  <br /> solution to client with their business <br /> problem</h1>
                ...
                <div className='grid-cols-3 grid mt-20  '>
                  <div className='mx-6'>
                   <h1 className=' text-red-600 text-6xl  '> <TfiDesktop/></h1>
                    <h1 className='mt-7 text-2xl font-bold'>Modern & Responsive design</h1>
                    <p className='mt-3 icon-color'>Lorem ipsum dolor sit amet, consectetur <br />adipisicing elit. Odit, ducimus.</p>
                  </div>
                  <div className='mx-6'>
                   <h1 className=' text-red-600 text-6xl '> <TfiDesktop/></h1>
                    <h1 className='mt-7 text-2xl font-bold'>Modern & Responsive design</h1>
              ...
              <div className=' grid grid-cols-7 items-center'>
               <BiSolidColorFill className=' text-6xl'/>
                <div className=' col-span-6' >
                  <h1 className=' font-semibold text-2xl'>We are Perfect Solution</h1>
                  <p className='icon-color'>We provide consulting services in the area of IFRS and management reporting, helping companies to reach their highest level. We optimize business processes, making them easier.</p>
                </div>
                </div>
            </div>
          </div>
         ...
         <div className=' container mt-12 m-auto mb-20 '>
                  ...
                  <div className='grid grid-cols-7  '>
                    <div className=' col-span-2 flex justify-end mr-3 mt-2'>
                   <h1 className=' icon-color text-5xl  '> <TfiDesktop/></h1>
                   </div>
                   <div className='col-span-5 ml-4'>
                    <h1 className=' text-2xl font-bold'>Web development.</h1>
                    <p className='mt-3 text-stone-500 leading-7'>A digital agency isn't here to replace <br />your internal team, we're here to <br />partner</p>
                    </div>
                  </div>
                  </div>
                  <div>
